...
{
  public static final String[] metaNames = { "Sheep", "Cow", "Deer" };
  ...
  public void registerIcons(IIconRegister registerer) { this.itemIcon = registerer.registerIcon("lwstfc:Bladder"); }
  ...
  public boolean canStack() { return true; }
